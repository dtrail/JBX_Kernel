...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV1, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB1, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV2, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB2, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV3, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB3, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV4, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB4, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV2, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV3, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV4, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP4 - OPP-NTSB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1100000000, OMAP4430_VDD_MPU_OPPNITROSB_UV1),
	/* MPU OPP4 - OPP-NTSB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1200000000, OMAP4430_VDD_MPU_OPPNITROSB_UV2),
	/* MPU OPP4 - OPP-NTSB */

...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBABB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBABB, 0xfa, 0x30, OMAP_ABB_FAST_OPP),
...
#endif
};										/* for future OC purposes to gain stable freq higher than 1400mhz, remind to set "0xfa, 0x27" to new "0xfa, 0x30" */

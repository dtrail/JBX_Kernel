...
#define OMAP4430_VDD_MPU_OPPNITROSBA_UV		1376000			/* 900 */
#define OMAP4430_VDD_MPU_OPPNITROSBAB_UV	1388000			/* 1008 */
#define OMAP4430_VDD_MPU_OPPNITROSBABA_UV	1398000			/* 1200 */
#define OMAP4430_VDD_MPU_OPPNITROSBABB_UV	1410000			/* 1400 */
#else
...
#ifdef CONFIG_OMAP_OCFREQ_12
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBABA_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBABA, 0, 0, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBABB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBABB, 0, 0, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
...
#ifdef CONFIG_OMAP_OCFREQ_12
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBABA_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBABA, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBABB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBABB, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100B_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
};
#else
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100B_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
#endif
...
#ifdef CONFIG_OMAP_OCFREQ_12
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSBABA_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSBABB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
#endif
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP4 - OPP-NTSB2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPNITROSBAB_UV),
#ifdef CONFIG_OMAP_OCFREQ_12
	/* MPU OPP4 - OPP-NTSB3 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1200000000, OMAP4430_VDD_MPU_OPPNITROSBABA_UV),
	/* MPU OPP4 - OPP-NTSB3 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1350000000, OMAP4430_VDD_MPU_OPPNITROSBABB_UV),
#endif
	/* MPU OPP1 - OPP50  */

...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBAB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBAB, 0, 0, 0xfa, 0x30, OMAP_ABB_FAST_OPP),
#else
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBAB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBAB, 0xfa, 0x30, OMAP_ABB_FAST_OPP),
#else

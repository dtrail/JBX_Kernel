...
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1378000			/* 900 */
#define OMAP4430_VDD_MPU_OPPNITROSBA_UV		1393000			/* 1100 */
#define OMAP4430_VDD_MPU_OPPNITROSBAB_UV	1410000			/* 1300 */
#else
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP4 - OPP-NTSB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 900000000, OMAP4430_VDD_MPU_OPPNITROSB_UV),
	/* MPU OPP4 - OPP-NTSB1 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1100000000, OMAP4430_VDD_MPU_OPPNITROSBA_UV),
	/* MPU OPP4 - OPP-NTSB2 */
	...
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", false, 512000000, OMAP4430_VDD_CORE_OPP100B_UV),
	/* FDIF OPP1 - OPP25 */

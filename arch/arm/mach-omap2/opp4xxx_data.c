...
#define OMAP4430_VDD_MPU_OPPNITROSBAB_UV	1410000			/* 1350 */
#else
...
#ifdef CONFIG_OMAP_OCFREQ_12
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBAB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBAB, 0, 0, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
#else
...
#ifdef CONFIG_OMAP_OCFREQ_12
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBAB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBAB, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
#else
